...
class QuizUI:
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        true_image = tkinter.PhotoImage(
            file="C:/Users/anshm/Documents/Python Projects/Quizller/images/true.png")
        false_image = tkinter.PhotoImage(
            file="C:/Users/anshm/Documents/Python Projects/Quizller/images/false.png")
        self.true_button = tkinter.Button(
            image=true_image, highlightthickness=0, command=self.pressed_true)
        self.false_button = tkinter.Button(
            image=false_image, highlightthickness=0, command=self.pressed_false)
